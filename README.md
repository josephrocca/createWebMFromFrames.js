...
* For some reason the resulting WebM videos don't play properly in VLC, but they do play properly in Chrome and Firefox (I haven't tested any others). There might be updates on this [here](https://github.com/w3c/webcodecs/issues/332#issuecomment-1341489961).
